...
public class MainPregunta1 {
    ...
    public static void main(String[] args) {
        ...
        //Problema 1 b)
        private static String printDeque(LinkedDeque<T> deque){
                if(deque.isEmpty)
                        return "";
                String r = deque.inicio.getDato().toString();
                LinearNode<T> aux = deque.inicio.getSig();
                return print(r,aux);
        }

        private static String print(String r,LinearNode<T> aux){
                if(aux == null)
                        return r;
                r = r + "\n"+ aux.getDato().toString();
                return print(r, aux.getSig());
        }
}
